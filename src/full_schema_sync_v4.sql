-- PM-POSHAN TRACKER: CONSOLIDATED SCHEMA SYNC (v4.0 - FINAL FIX)
-- Objective: Add 'standard_group', 'item_code', update constraints, and fix type mismatch in RPC.
...
BEGIN
    ...
    -- B. Add item_code to inventory_stock (Crucial for the RPC)
...
-- 2. INITIALIZE DATA (Set any NULLs)
...
-- 3. UPDATE UNIQUE CONSTRAINTS (Scoped by standard_group)
...
-- 4. FINAL ATOMIC RPC FUNCTION (With explicit JSONB casting & Robust Item Matching)
